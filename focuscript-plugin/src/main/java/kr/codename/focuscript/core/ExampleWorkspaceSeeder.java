...
public final class ExampleWorkspaceSeeder {
    ...
    public void seed() {
        try {
            ...
            Path srcDir = hello.resolve("src");
            Path partsDir = srcDir.resolve("parts");
            ...
            String mainFs = String.join("\n",
                    "#include \"parts/common.fs\"",
                    "#include \"parts/events.fs\"",
                    "#include \"parts/commands.fs\"",
                    "#include \"parts/scheduler.fs\"",
                    "#include \"parts/lifecycle.fs\"",
                    ""
            );
            java.nio.file.Files.writeString(srcDir.resolve("main.fs"), mainFs, StandardCharsets.UTF_8);

            String commonFs = String.join("\n",
            ...
            java.nio.file.Files.writeString(partsDir.resolve("common.fs"), commonFs, StandardCharsets.UTF_8);

            String eventsFs = String.join("\n",
                    "events.onJoin { e ->",
            ...
            java.nio.file.Files.writeString(partsDir.resolve("events.fs"), eventsFs, StandardCharsets.UTF_8);

            String commandsFs = String.join("\n",
            ...
            java.nio.file.Files.writeString(partsDir.resolve("commands.fs"), commandsFs, StandardCharsets.UTF_8);

            String schedulerFs = String.join("\n",
            ...
            java.nio.file.Files.writeString(partsDir.resolve("scheduler.fs"), schedulerFs, StandardCharsets.UTF_8);

            String lifecycleFs = String.join("\n",
                    "onDisable {",
                    "  storage.save()",
                    "}",
                    ""
            );
            java.nio.file.Files.writeString(partsDir.resolve("lifecycle.fs"), lifecycleFs, StandardCharsets.UTF_8);
